...
**Level Access (AMP browser extension):**

1. Install the [Level Access AMP extension](https://www.levelaccess.com/solutions/software/amp-browser-extensions/)

2. Open the page under test in Chrome/Firefox

3. Open DevTools → Level Access AMP panel

4. Run a full scan — take a screenshot of the results panel and share it with Claude (the extension does not support result export)

5. Address all **Critical** and **Serious** findings before merge
...
See [A11Y.md#screen-reader-commands](A11Y.md#screen-reader-commands) for VoiceOver and NVDA shortcuts.
...
| Level Access | Browser Extension | [levelaccess.com](https://www.levelaccess.com/) |
